...
#         output_label.config(text="Output: " + input_text.upper())
#     elif selected_option == "Option 2":
#         output_label.config(text="Output: " + input_text.lower())
...
# option_menu = tk.OptionMenu(root, var, "Option 1", "Option 2")
# option_menu.pack()
...
# show_message_button = tk.Button(root, text="Show Message", command=show_message)
